...
void Game::Init()
{
    //try
    {
        ...
        std::string vsFile2 = "/src/Utility/shaders/particle.vs";
        std::string frsFile2 = "/src/Utility/shaders/particle.frs";
        ResourceManager::LoadShader(currentDir + vsFile2, currentDir + frsFile2, "", "particle");
        // configure shaders
        ...
        std::strncpy(imageFile, currentDir, maxDir - 1);
        std::strncat(imageFile, "/Resources/imgs/particle.png", maxDir - strlen(imageFile) - 1);
        ResourceManager::LoadTexture(imageFile, true, "particle");
        ...
        std::strncat(levelFile, "/src/Utility/levels/one.lvl", maxDir - strlen(levelFile) - 1);
        GameLevel one; one.Load(levelFile, this->Width, this->Height / 2);
        std::strncpy(levelFile, currentDir, maxDir - 1);
        std::strncat(levelFile, "/src/Utility/levels/two.lvl", maxDir - strlen(levelFile) - 1);
        GameLevel two; two.Load(levelFile, this->Width, this->Height / 2);
        std::strncpy(levelFile, currentDir, maxDir - 1);
        std::strncat(levelFile, "/src/Utility/levels/three.lvl", maxDir - strlen(levelFile) - 1);
        GameLevel three; three.Load(levelFile, this->Width, this->Height / 2);
        std::strncpy(levelFile, currentDir, maxDir - 1);
        std::strncat(levelFile, "/src/Utility/levels/four.lvl", maxDir - strlen(levelFile) - 1);
...
void Game::ResetLevel()
{
    ...
    this->Levels[this->Level].Load(levelFile, this->Width, this->Height / 2);
}
